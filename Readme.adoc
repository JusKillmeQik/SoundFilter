...
It does so by having the item drops play voice lines from our favorite characters.
Instead of just 6 standard noises, this item filter has over 80 themed voice lines based on the item drop.
...
I know not all of these are masters but I like their voice lines so get ready to hear a lot of them.
